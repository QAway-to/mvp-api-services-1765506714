...
export default function WebhookInfo({ onBitrixUrlChange }) {
  ...
  const handleCopy = () => {
    const selectedUrl = WEBHOOK_ENDPOINTS[selectedEndpoint].url;
  ...
  const handleBitrixEndpointCopy = () => {
    navigator.clipboard.writeText(BITRIX_ENDPOINTS.bitrix.url);
  ...
  return (
    <div className="card">
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          <p style={{ color: '#94a3b8', marginBottom: '12px', fontSize: '0.9rem' }}>
            Bitrix24 webhook endpoint (static URL - configure once in Bitrix24):
          </p>
